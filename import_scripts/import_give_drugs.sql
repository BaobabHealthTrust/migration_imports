        ...
        ELSE #--5        
         ...
         IF NOT ISNULL(dispensed_drug_name2) THEN #--if dispensed2 is not null
          ...
          IF (@old_dispensing_encounter_id = 0) THEN #--onee
            ...
            VALUES (old_enc_id, @dispensing_encounter_type_id, patient_id, @provider, 
          ...
          ELSE #--onee
            ...
            IF (@already_existing_desc_id != 0) THEN 
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name2_new_concept_id, 1, old_enc_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
              ...
              INSERT INTO obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_drug,
                               value_numeric, creator, date_created, uuid)
              VALUES (patient_id, @amount_dispensed_concept_id, old_enc_id,
                      @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name2_concept_id,
                      dispensed_quantity2,@creator, date_created, (SELECT UUID()));
              ...
              IF (@arv_drug_concept_id != 0) THEN  #--7
                ...
                INSERT INTO obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_coded,
                                 creator, date_created, uuid)
                VALUES (patient_id, @arv_regimens_received_abstracted_construct_concept_id,
                        old_enc_id, @dispensed_without_pres_drug_order_id, encounter_datetime
                        ,@drug_concept_id, @creator, date_created, (SELECT UUID()));
             END IF; #--7
        ...
        ELSE #--5        
          ...
          ELSE #--onee
            ...
            IF (@already_existing_desc_id != 0) THEN 
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name3_new_concept_id, 1, old_enc_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
...
IF (@old_dispensing_encounter_id = 0) THEN #--onee
          ...
          ELSE #--onee
            ...
            IF (@already_existing_desc_id != 0) THEN 
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name4_new_concept_id, 1, old_enc_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
        ...
        IF (@old_dispensing_encounter_id = 0) THEN #--onee
          ...
          ELSE #--onee
            ...
            IF (@already_existing_desc_id != 0) THEN 
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name5_new_concept_id, 1, old_enc_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
