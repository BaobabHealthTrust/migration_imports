...
DROP PROCEDURE IF EXISTS `proc_import_patients_with_disp_wtht_pres`$$

# Procedure does not take any parameters. It assumes fixed table names and database
# names as working with flexible names is not supported as of writing in MySQL.
CREATE PROCEDURE `proc_import_patients_with_disp_wtht_pres`(
  #--IN start_pos INT(11),
  #--IN end_pos INT(11)
...
BEGIN
    ...
    read_loop: LOOP
        ...
        CALL proc_import_give_drugs_disp_wtht_pres(@person_id);                      # good
