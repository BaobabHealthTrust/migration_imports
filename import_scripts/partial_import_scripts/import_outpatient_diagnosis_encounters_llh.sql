...
DROP PROCEDURE IF EXISTS `proc_import_outpatient_diagnosis_encounters_llh`$$

# Procedure does not take any parameters. It assumes fixed table names and database
# names as working with flexible names is not supported as of writing in MySQL.
CREATE PROCEDURE `proc_import_outpatient_diagnosis_encounters_llh`(
...
DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
    ...
    SET @encounter_id = (SELECT LAST_INSERT_ID());
          ...
          IF ISNULL(refer_to_anotha_hosp) THEN
              ...
              VALUES (patient_id, @refer_to_anotha_hosp_concept_id, @encounter_id, encounter_datetime, @location_id , @refer_to_anotha_hosp_value_coded, @refer_to_anotha_hosp_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(pri_diagnosis) THEN
            IF (pri_diagnosis <> "Not applicable") THEN
              ...
              IF ISNULL(@pri_diagnosis_value_coded) THEN
                ...
                VALUES (patient_id, @pri_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @bart2_primary_diagnosis_name, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
                VALUES (patient_id, @pri_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @pri_diagnosis_value_coded, @pri_diagnosis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
              END IF;
              ...
              IF (pri_diagnosis = "Diarrhoea disease(non-bloody)") THEN
                # Create detailed_primary_diagnosis_observation
                  ...
                  IF ISNULL (@detailed_pri_diag) THEN
                    INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                    VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'non-bloody', @creator, date_created, (SELECT UUID()));
                  ELSE
                    INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                    VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @detailed_pri_diag, @creator, date_created, (SELECT UUID()));
                  END IF;
              ...
              ELSEIF (pri_diagnosis = "Sprains (Joint Soft Tissue Injury)") THEN
                  ...
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @detailed_diagnosis_name_concept_id, @detailed_diagnosis_name_concept_name_id, @creator, date_created, (SELECT UUID()));
               ...
               ELSEIF (pri_diagnosis = "Soft Tissue Injury (Excluding Joints)") THEN
                   ...
                   SET @detailed_sec_diag3 = (SELECT concept_name.concept_id FROM concept_name
                    ...
                    IF ISNULL (@detailed_sec_diag3) THEN
                      INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                      VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Excluding Joints', @creator, date_created, (SELECT UUID()));
                    ELSE
                      INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                      VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @detailed_sec_diag3, @creator, date_created, (SELECT UUID()));
                    END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Clavicle') THEN
                ...
                IF ISNULL (@fracture_1_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Clavicle', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_1_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Malleoral') THEN
                ...
                IF ISNULL (@fracture_2_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Malleolar', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_2_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Metacarpals') THEN
               ...
               IF ISNULL (@fracture_3_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Metacarpal', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_3_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Metatarsal') THEN
                ...
                IF ISNULL (@fracture_4_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Metatarsal', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_4_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Spine') THEN
                ...
                IF ISNULL (@fracture_5_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Spine', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_5_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Pelvis') THEN
                ...
                IF ISNULL (@fracture_6_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Pelvis', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_6_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Femur') THEN
                ...
                IF ISNULL (@fracture_7_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Femur', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_7_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Humerus') THEN
                ...
                IF ISNULL (@fracture_8_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Humerus', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_8_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Phalanges') THEN
                ...
                IF ISNULL (@fracture_9_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Phalanges', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_9_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Radius/ulna') THEN
                ...
                IF ISNULL (@fracture_10_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Radius/ulna', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_10_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Fractures Tibia/Fibula') THEN
                ...
                IF ISNULL (@fracture_11_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Tibia/Fibula', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_11_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (pri_diagnosis = 'Open Fracture') THEN
                ...
                IF ISNULL (@fracture_12_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Open Fracture', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_primary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_12_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
          ...
          IF NOT ISNULL(sec_diagnosis) THEN
            IF (sec_diagnosis <> "Not applicable") THEN
              ...
              IF ISNULL(@sec_diagnosis_value_coded) THEN
                ...
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                VALUES (patient_id, @sec_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @bart2_secondary_diagnosis_name, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation with drug_name as value_coded
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
                VALUES (patient_id, @sec_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @sec_diagnosis_value_coded, @sec_diagnosis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
              END IF;
              ...
              IF (sec_diagnosis = "Diarrhoea disease(non-bloody)") THEN
                # Create detailed_secondary_diagnosis_observation
                  ...
                  IF ISNULL (@detailed_sec_diag) THEN
                    INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                    VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'non-bloody', @creator, date_created, (SELECT UUID()));
                  ELSE
                    INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                    VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @detailed_sec_diag, @creator, date_created, (SELECT UUID()));
                  END IF;
              ...
              ELSEIF (sec_diagnosis = "Sprains (Joint Soft Tissue Injury)") THEN
                ...
                # Create observation with drug_name as value_coded
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
                VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @detailed_diagnosis_name_concept_id, @detailed_diagnosis_name_concept_name_id, @creator, date_created, (SELECT UUID()));
              ...
              ELSEIF (sec_diagnosis = "Soft Tissue Injury (Excluding Joints)") THEN
                ...
                SET @detailed_sec_diag2 = (SELECT concept_name.concept_id FROM concept_name
                  ...
                  IF ISNULL (@detailed_sec_diag2) THEN
                    INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                    VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Excluding Joints', @creator, date_created, (SELECT UUID()));
                  ELSE
                    INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                    VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @detailed_sec_diag2, @creator, date_created, (SELECT UUID()));
                  END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Clavicle') THEN
                ...
                IF ISNULL (@fracture_1_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Clavicle', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_1_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Malleoral') THEN
                ...
                IF ISNULL (@fracture_2_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Malleolar', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_2_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Metacarpals') THEN
               ...
               IF ISNULL (@fracture_3_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Metacarpal', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_3_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Metatarsal') THEN
                ...
                IF ISNULL (@fracture_4_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Metatarsal', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_4_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Spine') THEN
                ...
                IF ISNULL (@fracture_5_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Spine', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_5_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Pelvis') THEN
                ...
                IF ISNULL (@fracture_6_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Pelvis', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_6_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Femur') THEN
                ...
                IF ISNULL (@fracture_7_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Femur', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_7_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Humerus') THEN
                ...
                IF ISNULL (@fracture_8_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Humerus', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_8_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Phalanges') THEN
                ...
                IF ISNULL (@fracture_9_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Phalanges', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_9_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Radius/ulna') THEN
                ...
                IF ISNULL (@fracture_10_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Radius/ulna', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_10_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Fractures Tibia/Fibula') THEN
                ...
                IF ISNULL (@fracture_11_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Tibia/Fibula', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_11_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
              ...
              ELSEIF (sec_diagnosis = 'Open Fracture') THEN
                ...
                IF ISNULL (@fracture_12_detailed) THEN
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , 'Open Fracture', @creator, date_created, (SELECT UUID()));
                ELSE
                  INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, creator, date_created, uuid)
                  VALUES (patient_id, @detailed_secondary_diagnosis_concept_id, @encounter_id, encounter_datetime, @location_id , @fracture_12_detailed, @creator, date_created, (SELECT UUID()));
                END IF;
  ...
  #-----------------------------------------------------------------------------------------------------------------------------
          ...
          IF NOT ISNULL(treatment1) THEN
              ...
              IF ISNULL(@treatment_value_coded) THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                VALUES (patient_id, @treatment_concept_id, @encounter_id, encounter_datetime, @location_id , @bart2_drug_concept_name,  @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
                VALUES (patient_id, @treatment_concept_id, @encounter_id, encounter_datetime, @location_id , @treatment_value_coded, @treatment_value_coded_name_id, @creator, date_created, (SELECT UUID()));
              END IF;
