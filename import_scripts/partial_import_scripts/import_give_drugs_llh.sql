...
DROP PROCEDURE IF EXISTS `proc_import_give_drugs_llh`$$

# Procedure does not take any parameters. It assumes fixed table names and database
# names as working with flexible names is not supported as of writing in MySQL.
CREATE PROCEDURE `proc_import_give_drugs_llh`(
...
#-----------------------------------------------------------------------------------------------------------------------------------
      ...
      IF NOT ISNULL(@pres_drug_name1) THEN #-- AND (pres_drug_name1 != 'Unknown ARV drug') THEN #--1
        ...
        VALUES (@encounter_type, patient_id, @provider, encounter_datetime, @creator, date_created, @encounter_uuid)
        ...
        ELSE #--5        
         ...
         IF NOT ISNULL(dispensed_drug_name1) THEN
           ...
           ELSE
            ...
            VALUES (patient_id, @amount_dispensed_concept_id, o@dispensing_without_pres_encounter_id, @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name1_concept_id, dispensed_quantity1,@creator, date_created, (SELECT UUID()));
...
#--------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      IF NOT ISNULL(@pres_drug_name2) THEN #-- (pres_drug_name2 != 'Unknown ARV drug') THEN #--1
        SET @treatment_encounter_id = COALESCE((SELECT encounter_id FROM encounter WHERE encounter_id = @encounter),0);
        ...
        IF (@treatment_encounter_id = 0) THEN
          ...
          INSERT INTO encounter (encounter_type, patient_id, provider_id, encounter_datetime, creator, date_created, uuid)
          VALUES (@encounter_type, patient_id, @provider, encounter_datetime, @creator, date_created, @encounter_uuid) ON DUPLICATE KEY UPDATE encounter_id = old_enc_id, voided = 0;
        ...
        ELSE #--5        
         ...
         IF NOT ISNULL(dispensed_drug_name2) THEN #--if dispensed2 is not null
          ...
          IF (@old_dispensing_encounter_id = 0) THEN #--onee
            INSERT INTO encounter (encounter_type, patient_id, provider_id,
                                   encounter_datetime, creator, date_created, uuid)
            VALUES (@dispensing_encounter_type_id, patient_id, @provider, 
                    encounter_datetime, @creator, date_created, (SELECT UUID())) 
            ON DUPLICATE KEY UPDATE encounter_id = old_enc_id;
            ...
            INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                start_date, auto_expire_date, creator, date_created, uuid)
            VALUES (1, @dispensed_drug_name2_new_concept_id, 1, @dispensing_without_pres_encounter_id,
                    patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));

            SET @dispensed_without_pres_drug_order_id = (SELECT LAST_INSERT_ID());

            #create drug_order without quantity
            INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
            VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name2_concept_id, dispensed_dosage2, 
                    pres_dosage2, pres_frequency2, dispensed_quantity2);
            ...
            VALUES (patient_id, @amount_dispensed_concept_id, @dispensing_without_pres_encounter_id,
                    @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name2_concept_id,
                    dispensed_quantity2,@creator, date_created, (SELECT UUID()));
            ...
            IF (@arv_drug_concept_id != 0) THEN  #--7
              ...
              VALUES (patient_id, @arv_regimens_received_abstracted_construct_concept_id,
                      @dispensing_without_pres_encounter_id, @dispensed_without_pres_drug_order_id, encounter_datetime
                      ,@drug_concept_id, @creator, date_created, (SELECT UUID()));
           END IF; #--7
          
          ELSE #--onee

            SET @already_existing_desc_id = COALESCE((SELECT en.encounter_id FROM encounter en
                                                      WHERE en.encounter_type = 54
                                                      AND en.encounter_datetime = encounter_datetime
                                                      AND en.patient_id = patient_id
                                                      ANd en.voided = 0), 0);         
            IF (@already_existing_desc_id != 0) THEN 
              #create orders, drug_orders and obs
              IF NOT ISNULL(prescription_duration) THEN #--11
                SET @auto_expire_date = NULL;
                SET @auto_expire_date = (SELECT
                 CASE WHEN TRIM(REPLACE(SUBSTRING(prescription_duration,INSTR(prescription_duration, ' ')),'s','')) = 'Month' THEN
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name2_new_concept_id, 1, @encounter_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
              ...
              INSERT INTO obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_drug,
                               value_numeric, creator, date_created, uuid)
              VALUES (patient_id, @amount_dispensed_concept_id, @encounter_id,
                      @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name2_concept_id,
                      dispensed_quantity2,@creator, date_created, (SELECT UUID()));
              ...
              IF (@arv_drug_concept_id != 0) THEN  #--7
                ...
                INSERT INTO obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_coded,
                                 creator, date_created, uuid)
                VALUES (patient_id, @arv_regimens_received_abstracted_construct_concept_id,
                        @encounter_id, @dispensed_without_pres_drug_order_id, encounter_datetime
                        ,@drug_concept_id, @creator, date_created, (SELECT UUID()));
             END IF; #--7
            ELSE #--create in temp_encounter
              ...
              IF (@old_temp_encounter_id = 0) THEN
                INSERT INTO temp_encounter (encounter_type, patient_id, provider_id, encounter_datetime, 
                                            creator, date_created, uuid)
                VALUES (@dispensing_encounter_type_id, patient_id, @provider, encounter_datetime, 
              ...
              VALUES (1, @dispensed_drug_name2_new_concept_id, 1, @dispensing_without_pres_encounter_id, patient_id, 
                      encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
              ...
              INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
              VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name2_concept_id, dispensed_dosage2,
                      dispensed_dosage2, pres_frequency2, dispensed_quantity2);

              #create amount dispensed obs
              INSERT INTO temp_obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_drug,
                                    value_numeric, creator, date_created, uuid)
              VALUES (patient_id, @amount_dispensed_concept_id, @dispensing_without_pres_encounter_id,
                     @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name2_concept_id,
                     dispensed_quantity2,@creator, date_created, (SELECT UUID()));
              ...
              IF (@arv_drug_concept_id != 0) THEN  #--7
                #create arv_regimen_received_abstracted_construct obs
                INSERT INTO temp_obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_coded, 
                                      creator, date_created, uuid)
                VALUES (patient_id, @arv_regimens_received_abstracted_construct_concept_id,
                        @dispensing_without_pres_encounter_id, @dispensed_without_pres_drug_order_id,
                        encounter_datetime, @drug_concept_id, @creator, date_created, (SELECT UUID()));
              END IF; #--7 
            END IF;
    ...
    ELSE #--1
      ...
      IF NOT ISNULL(dispensed_drug_name2) THEN #--if dispensed2 is not null
        ...
        IF (@old_dispensing_encounter_id = 0) THEN #--onee
          INSERT INTO encounter (encounter_type, patient_id, provider_id, encounter_datetime, creator, date_created, uuid)
          VALUES (@dispensing_encounter_type_id, patient_id, @provider, encounter_datetime, @creator, date_created, (SELECT UUID())) ON DUPLICATE KEY UPDATE encounter_id = old_enc_id;
 ...
 #---------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      IF NOT ISNULL(@pres_drug_name3) THEN #--(pres_drug_name3 != 'Unknown ARV drug') THEN #--1
        SET @treatment_encounter_id = COALESCE((SELECT encounter_id FROM encounter WHERE encounter_id = @encounter_id),0);
       ...
       ELSEIF (pres_drug_name3 = dispensed_drug_name4) THEN #--5
        ...
        ELSE #--5        
          ...
          IF (@old_dispensing_encounter_id = 0) THEN #--onee
            ...
            INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                start_date, auto_expire_date, creator, date_created, uuid)
            VALUES (1, @dispensed_drug_name3_new_concept_id, 1, @dispensing_without_pres_encounter_id,
                    patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
            ...
            #create drug_order without quantity
            INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
            VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name3_concept_id, dispensed_dosage3, 
                    pres_dosage3, pres_frequency3, dispensed_quantity3);

            #create amount dispensed obs
            INSERT INTO obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_drug,
                             value_numeric, creator, date_created, uuid)
            VALUES (patient_id, @amount_dispensed_concept_id, @dispensing_without_pres_encounter_id,
                    @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name3_concept_id,
                    dispensed_quantity3,@creator, date_created, (SELECT UUID()));
          ...
          ELSE #--onee
            ...
            IF (@already_existing_desc_id != 0) THEN 
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name3_new_concept_id, 1, @encounter_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
            ...
            ELSE #--create in temp_encounter
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, start_date, 
                                  auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name3_new_concept_id, 1, @dispensing_without_pres_encounter_id, patient_id, 
                      encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
              ...
              INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
              VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name3_concept_id, dispensed_dosage3,
                      dispensed_dosage3, pres_frequency3, dispensed_quantity3);
...
IF (@old_dispensing_encounter_id = 0) THEN #--onee
            ...
            INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                start_date, auto_expire_date, creator, date_created, uuid)
            VALUES (1, @dispensed_drug_name4_new_concept_id, 1, @dispensing_without_pres_encounter_id,
                    patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
            ...
            #create drug_order without quantity
            INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
            VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name4_concept_id, dispensed_dosage4, 
                    pres_dosage4, pres_frequency4, dispensed_quantity4);

            #create amount dispensed obs
            INSERT INTO obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_drug,
                             value_numeric, creator, date_created, uuid)
            VALUES (patient_id, @amount_dispensed_concept_id, @dispensing_without_pres_encounter_id,
                    @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name4_concept_id,
                    dispensed_quantity4,@creator, date_created, (SELECT UUID()));
          ...
          ELSE #--onee
            ...
            IF (@already_existing_desc_id != 0) THEN 
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name4_new_concept_id, 1, @encounter_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
            ...
            ELSE #--create in temp_encounter
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, start_date, 
                                  auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name4_new_concept_id, 1, @dispensing_without_pres_encounter_id, patient_id, 
                      encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
              ...
              INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
              VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name4_concept_id, dispensed_dosage4,
                      dispensed_dosage4, pres_frequency4, dispensed_quantity4);
      ...
      IF NOT ISNULL(@pres_drug_name5) THEN #-- AND (pres_drug_name5 != 'Unknown ARV drug') THEN #--1
       ...
       ELSEIF (pres_drug_name5 = dispensed_drug_name4) THEN #--5
        ...
        IF (@old_dispensing_encounter_id = 0) THEN #--onee
            ...
            INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                start_date, auto_expire_date, creator, date_created, uuid)
            VALUES (1, @dispensed_drug_name5_new_concept_id, 1, @dispensing_without_pres_encounter_id,
                    patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
            ...
            #create drug_order without quantity
            INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
            VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name5_concept_id, dispensed_dosage5, 
                    pres_dosage5, pres_frequency5, dispensed_quantity5);

            #create amount dispensed obs
            INSERT INTO obs (person_id, concept_id, encounter_id, order_id, obs_datetime, value_drug,
                             value_numeric, creator, date_created, uuid)
            VALUES (patient_id, @amount_dispensed_concept_id, @dispensing_without_pres_encounter_id,
                    @dispensed_without_pres_drug_order_id, encounter_datetime, @dispensed_drug_name5_concept_id,
                    dispensed_quantity5,@creator, date_created, (SELECT UUID()));
          ...
          ELSE #--onee
            ...
            IF (@already_existing_desc_id != 0) THEN 
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, 
                                  start_date, auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name5_new_concept_id, 1, @encounter_id,
                      patient_id, encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
            ...
            ELSE #--create in temp_encounter
              ...
              INSERT INTO orders (order_type_id, concept_id, orderer, encounter_id, patient_id, start_date, 
                                  auto_expire_date, creator, date_created, uuid)
              VALUES (1, @dispensed_drug_name5_new_concept_id, 1, @dispensing_without_pres_encounter_id, patient_id, 
                      encounter_datetime, @auto_expire_date, @creator,  date_created, (SELECT UUID()));
              ...
              INSERT INTO drug_order (order_id, drug_inventory_id, equivalent_daily_dose, dose, frequency, quantity)
              VALUES (@dispensed_without_pres_drug_order_id, @dispensed_drug_name5_concept_id, dispensed_dosage5,
                      dispensed_dosage5, pres_frequency5, dispensed_quantity5);
...
#--------------------------------------------------------------------------------------------------------------------------------------------------
  IF NOT ISNULL(appointment_date) THEN
    ...
    INSERT INTO temp_encounter (encounter_type, patient_id, provider_id, encounter_datetime, creator, date_created, uuid)
    VALUES (@appointment_encounter_type_id, patient_id, @provider, encounter_datetime, @creator, date_created, @appointment_date_uuid) ON DUPLICATE KEY UPDATE encounter_id = @encounter_id, voided = 0;
