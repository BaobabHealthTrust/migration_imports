...
DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
	...
	INSERT INTO encounter (encounter_id, encounter_type, patient_id, provider_id, location_id, encounter_datetime, creator, date_created, uuid) VALUES (old_enc_id, @encounter_type, patient_id, @provider, @location_id, encounter_datetime, @creator, date_created, (SELECT UUID())) ON DUPLICATE KEY UPDATE encounter_id = old_enc_id;
        ...
        IF NOT ISNULL(cryptococcal_meningitis_or_other_eptb_cryptococcosis) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @cryptococcal_meningitis_or_other_eptb_cryptococcosis_concept_id, old_enc_id, encounter_datetime, @location_id , @cryptococcal_meningitis_or_other_eptb_cryptococcosis_value_coded, @cryptococcal_meningitis_or_other_eptb_cryptococcosis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(candidiasis_of_oesophagus_trachea_bronchi_or_lungs) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @candidiasis_of_oesophagus_trachea_bronchi_or_lungs_concept_id, old_enc_id, encounter_datetime, @location_id , @candidiasis_of_oesophagus_trachea_bronchi_or_lungs_value_coded, @candidiasis_of_oesophagus_trachea_bronchi_or_lungs_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(severe_unexplained_wasting_malnutrition) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @severe_unexplained_wasting_malnutrition_concept_id, old_enc_id, encounter_datetime, @location_id , @severe_unexplained_wasting_malnutrition_value_coded, @severe_unexplained_wasting_malnutrition_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(diarrhoea_chronic_less_1_month_unexplained) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @diarrhoea_chronic_less_1_month_unexplained_concept_id, old_enc_id, encounter_datetime, @location_id , @diarrhoea_chronic_less_1_month_unexplained_value_coded, @diarrhoea_chronic_less_1_month_unexplained_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(moderate_weight_loss_10_unexplained) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @moderate_weight_loss_10_unexplained_concept_id, old_enc_id, encounter_datetime, @location_id , @moderate_weight_loss_10_unexplained_value_coded, @moderate_weight_loss_10_unexplained_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(acute_necrotizing_ulcerative_stomatitis_gingivitis_or_period) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @acute_necrotizing_ulcerative_stomatitis_gingivitis_or_period_concept_id, old_enc_id, encounter_datetime, @location_id , @acute_necrotizing_ulcerative_stomatitis_gingivitis_or_period_value_coded, @acute_necrotizing_ulcerative_stomatitis_gingivitis_or_period_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(moderate_unexplained_wasting_malnutrition) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @moderate_unexplained_wasting_malnutrition_concept_id, old_enc_id, encounter_datetime, @location_id , @moderate_unexplained_wasting_malnutrition_value_coded, @moderate_unexplained_wasting_malnutrition_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(diarrhoea_persistent_unexplained_14_days_or_more) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @diarrhoea_persistent_unexplained_14_days_or_more_concept_id, old_enc_id, encounter_datetime, @location_id , @diarrhoea_persistent_unexplained_14_days_or_more_value_coded, @diarrhoea_persistent_unexplained_14_days_or_more_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(acute_ulcerative_mouth_infections) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @acute_ulcerative_mouth_infections_concept_id, old_enc_id, encounter_datetime, @location_id , @acute_ulcerative_mouth_infections_value_coded, @acute_ulcerative_mouth_infections_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(anaemia_unexplained_8_g_dl) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @anaemia_unexplained_8_g_dl_concept_id, old_enc_id, encounter_datetime, @location_id , @anaemia_unexplained_8_g_dl_value_coded, @anaemia_unexplained_8_g_dl_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(atypical_mycobacteriosis_disseminated_or_lung) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @atypical_mycobacteriosis_disseminated_or_lung_concept_id, old_enc_id, encounter_datetime, @location_id , @atypical_mycobacteriosis_disseminated_or_lung_value_coded, @atypical_mycobacteriosis_disseminated_or_lung_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(bacterial_infections_sev_recurrent_excluding_pneumonia) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @bacterial_infections_sev_recurrent_excluding_pneumonia_concept_id, old_enc_id, encounter_datetime, @location_id , @bacterial_infections_sev_recurrent_excluding_pneumonia_value_coded, @bacterial_infections_sev_recurrent_excluding_pneumonia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(cancer_cervix) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @cancer_cervix_concept_id, old_enc_id, encounter_datetime, @location_id , @cancer_cervix_value_coded, @cancer_cervix_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(chronic_herpes_simplex_infection_genital) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @chronic_herpes_simplex_infection_genital_concept_id, old_enc_id, encounter_datetime, @location_id , @chronic_herpes_simplex_infection_genital_value_coded, @chronic_herpes_simplex_infection_genital_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(cryptosporidiosis_chronic_with_diarrhoea) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @cryptosporidiosis_chronic_with_diarrhoea_concept_id, old_enc_id, encounter_datetime, @location_id , @cryptosporidiosis_chronic_with_diarrhoea_value_coded, @cryptosporidiosis_chronic_with_diarrhoea_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(cytomegalovirus_infection_retinitis_or_other_organ) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @cytomegalovirus_infection_retinitis_or_other_organ_concept_id, old_enc_id, encounter_datetime, @location_id , @cytomegalovirus_infection_retinitis_or_other_organ_value_coded, @cytomegalovirus_infection_retinitis_or_other_organ_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(cytomegalovirus_of_an_organ_other_than_liver) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @cytomegalovirus_of_an_organ_other_than_liver_concept_id, old_enc_id, encounter_datetime, @location_id , @cytomegalovirus_of_an_organ_other_than_liver_value_coded, @cytomegalovirus_of_an_organ_other_than_liver_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(fungal_nail_infections) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @fungal_nail_infections_concept_id, old_enc_id, encounter_datetime, @location_id , @fungal_nail_infections_value_coded, @fungal_nail_infections_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(herpes_simplex_infection_mucocutaneous_visceral) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @herpes_simplex_infection_mucocutaneous_visceral_concept_id, old_enc_id, encounter_datetime, @location_id , @herpes_simplex_infection_mucocutaneous_visceral_value_coded, @herpes_simplex_infection_mucocutaneous_visceral_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(hiv_associated_cardiomyopathy) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @hiv_associated_cardiomyopathy_concept_id, old_enc_id, encounter_datetime, @location_id , @hiv_associated_cardiomyopathy_value_coded, @hiv_associated_cardiomyopathy_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(hiv_associated_nephropathy) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @hiv_associated_nephropathy_concept_id, old_enc_id, encounter_datetime, @location_id , @hiv_associated_nephropathy_value_coded, @hiv_associated_nephropathy_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(invasive_cancer_cervix) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @invasive_cancer_cervix_concept_id, old_enc_id, encounter_datetime, @location_id , @invasive_cancer_cervix_value_coded, @invasive_cancer_cervix_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(isosporiasis_1_month) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @isosporiasis_1_month_concept_id, old_enc_id, encounter_datetime, @location_id , @isosporiasis_1_month_value_coded, @isosporiasis_1_month_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(leishmaniasis_atypical_disseminated) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @leishmaniasis_atypical_disseminated_concept_id, old_enc_id, encounter_datetime, @location_id , @leishmaniasis_atypical_disseminated_value_coded, @leishmaniasis_atypical_disseminated_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(moderate_unexplained_malnutrition) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @moderate_unexplained_malnutrition_concept_id, old_enc_id, encounter_datetime, @location_id , @moderate_unexplained_malnutrition_value_coded, @moderate_unexplained_malnutrition_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(molluscum_contagiosum_extensive) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @molluscum_contagiosum_extensive_concept_id, old_enc_id, encounter_datetime, @location_id , @molluscum_contagiosum_extensive_value_coded, @molluscum_contagiosum_extensive_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(non_typhoidal_salmonella_bacteraemia_recurrent) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @non_typhoidal_salmonella_bacteraemia_recurrent_concept_id, old_enc_id, encounter_datetime, @location_id , @non_typhoidal_salmonella_bacteraemia_recurrent_value_coded, @non_typhoidal_salmonella_bacteraemia_recurrent_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(oral_candidiasis_from_age_2_months) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @oral_candidiasis_from_age_2_months_concept_id, old_enc_id, encounter_datetime, @location_id , @oral_candidiasis_from_age_2_months_value_coded, @oral_candidiasis_from_age_2_months_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(oral_thrush) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @oral_thrush_concept_id, old_enc_id, encounter_datetime, @location_id , @oral_thrush_value_coded, @oral_thrush_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(perform_extended_staging) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @perform_extended_staging_concept_id, old_enc_id, encounter_datetime, @location_id , @perform_extended_staging_value_coded, @perform_extended_staging_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(pneumocystis_carinii_pneumonia) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @pneumocystis_carinii_pneumonia_concept_id, old_enc_id, encounter_datetime, @location_id , @pneumocystis_carinii_pneumonia_value_coded, @pneumocystis_carinii_pneumonia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(pneumonia_severe) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @pneumonia_severe_concept_id, old_enc_id, encounter_datetime, @location_id , @pneumonia_severe_value_coded, @pneumonia_severe_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(recurrent_bacteraemia_or_sepsis_with_nts) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @recurrent_bacteraemia_or_sepsis_with_nts_concept_id, old_enc_id, encounter_datetime, @location_id , @recurrent_bacteraemia_or_sepsis_with_nts_value_coded, @recurrent_bacteraemia_or_sepsis_with_nts_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(recurrent_severe_presumed_pneumonia) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @recurrent_severe_presumed_pneumonia_concept_id, old_enc_id, encounter_datetime, @location_id , @recurrent_severe_presumed_pneumonia_value_coded, @recurrent_severe_presumed_pneumonia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(recurrent_upper_respiratory_tract_bac_sinusitis) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @recurrent_upper_respiratory_tract_bac_sinusitis_concept_id, old_enc_id, encounter_datetime, @location_id , @recurrent_upper_respiratory_tract_bac_sinusitis_value_coded, @recurrent_upper_respiratory_tract_bac_sinusitis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(seborrhoeic_dermatitis) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @seborrhoeic_dermatitis_concept_id, old_enc_id, encounter_datetime, @location_id , @seborrhoeic_dermatitis_value_coded, @seborrhoeic_dermatitis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(sepsis_severe) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @sepsis_severe_concept_id, old_enc_id, encounter_datetime, @location_id , @sepsis_severe_value_coded, @sepsis_severe_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(tb_lymphadenopathy) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @tb_lymphadenopathy_concept_id, old_enc_id, encounter_datetime, @location_id , @tb_lymphadenopathy_value_coded, @tb_lymphadenopathy_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(unexplained_anaemia_neutropenia_or_thrombocytopenia) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @unexplained_anaemia_neutropenia_or_thrombocytopenia_concept_id, old_enc_id, encounter_datetime, @location_id , @unexplained_anaemia_neutropenia_or_thrombocytopenia_value_coded, @unexplained_anaemia_neutropenia_or_thrombocytopenia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
       ...
       # Check if the field is not empty
        IF NOT ISNULL(visceral_leishmaniasis) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @visceral_leishmaniasis_concept_id, old_enc_id, encounter_datetime, @location_id , @visceral_leishmaniasis_value_coded, @visceral_leishmaniasis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
