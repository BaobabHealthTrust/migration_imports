...
DECLARE cur CURSOR FOR SELECT DISTINCT `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`id`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`visit_encounter_id`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`old_enc_id`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`patient_id`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`patient_present`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`location`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`voided`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`void_reason`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`date_voided`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`voided_by`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`date_created`, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`creator`, COALESCE(`bart1_area_25_intermediate_tables`.`visit_encounters`.visit_date, `bart1_area_25_intermediate_tables`.`general_reception_encounters`.date_created) FROM `bart1_area_25_intermediate_tables`.`general_reception_encounters` LEFT OUTER JOIN `bart1_area_25_intermediate_tables`.`visit_encounters` ON
        visit_encounter_id = `bart1_area_25_intermediate_tables`.`visit_encounters`.`id`
        WHERE `bart1_area_25_intermediate_tables`.`general_reception_encounters`.`patient_id` = in_patient_id;
