...
DROP PROCEDURE IF EXISTS `proc_import_art_visit_encounters_llh_missing_visit`$$

# Procedure does not take any parameters. It assumes fixed table names and database
# names as working with flexible names is not supported as of writing in MySQL.
CREATE PROCEDURE `proc_import_art_visit_encounters_llh_missing_visit`(
IN in_patient_id INT(11),
IN in_encounter_datetime VARCHAR(255)
)
...
`bart1_intermediate_bare_bones`.`art_visit_encounters`.`encounter_datetime`, `bart1_intermediate_bare_bones`.`art_visit_encounters`.`date_created`, `bart1_intermediate_bare_bones`.`art_visit_encounters`.`creator`, COALESCE(`bart1_intermediate_bare_bones`.`visit_encounters`.visit_date, `bart1_intermediate_bare_bones`.`art_visit_encounters`.date_created) FROM `bart1_intermediate_bare_bones`.`art_visit_encounters` LEFT OUTER JOIN `bart1_intermediate_bare_bones`.`visit_encounters` ON
        ...
        AND `bart1_intermediate_bare_bones`.`art_visit_encounters`.`encounter_datetime` = in_encounter_datetime;
...
DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
    ...
    SET @drug_name_brought_to_clinic4_drug_id = (SELECT new_drug_id FROM drug_map 
	  ...
	  SET @encounter_type = (SELECT encounter_type_id FROM encounter_type WHERE name = 'HIV CLINIC CONSULTATION' LIMIT 1);
    ...
    SET @encounter_id = (SELECT LAST_INSERT_ID());
          ...
          IF NOT ISNULL(using_family_planning_method) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @using_family_planning_method_concept_id, @encounter_id, encounter_datetime, @location_id , @using_family_planning_method_value_coded, @using_family_planning_method_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(family_planning_method_used) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @family_planning_method_used_concept_id, @encounter_id, encounter_datetime, @location_id , @family_planning_method_used_value_coded, @family_planning_method_used_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(abdominal_pains) THEN
            IF (abdominal_pains = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @abdominal_pains_concept_id, @encounter_id, encounter_datetime, @location_id , @abdominal_pains_value_coded, @abdominal_pains_value_coded_name_id, @creator, date_created, (SELECT UUID()));
...
# Get value_coded id
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @other_symptoms_concept_id, @encounter_id, encounter_datetime, @location_id , @other_symptoms_value_coded, @other_symptoms_value_coded_name_id, @creator, date_created, (SELECT UUID()));
            ...
            ELSEIF (abdominal_pains = 'Yes drug induced') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_value_coded, @drug_induced_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(anorexia) THEN
            IF (anorexia = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @anorexia_concept_id, @encounter_id, encounter_datetime, @location_id , @anorexia_value_coded, @anorexia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(cough) THEN
            IF (cough = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @cough_concept_id, @encounter_id, encounter_datetime, @location_id , @cough_value_coded, @cough_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(diarrhoea) THEN
            IF (diarrhoea = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @diarrhoea_concept_id, @encounter_id, encounter_datetime, @location_id , @diarrhoea_value_coded, @diarrhoea_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(fever) THEN
            IF (fever = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @fever_concept_id, @encounter_id, encounter_datetime, @location_id , @fever_value_coded, @fever_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(jaundice) THEN
            IF (jaundice = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @jaundice_concept_id, @encounter_id, encounter_datetime, @location_id , @jaundice_value_coded, @jaundice_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(leg_pain_numbness) THEN
            IF (leg_pain_numbness = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @leg_pain_numbness_concept_id, @encounter_id, encounter_datetime, @location_id , @leg_pain_numbness_value_coded, @leg_pain_numbness_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(vomit) THEN
            IF (vomit = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @vomit_concept_id, @encounter_id, encounter_datetime, @location_id , @vomit_value_coded, @vomit_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(weight_loss) THEN
            IF (weight_loss = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @weight_loss_concept_id, @encounter_id, encounter_datetime, @location_id , @weight_loss_value_coded, @weight_loss_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(peripheral_neuropathy) THEN
            IF (peripheral_neuropathy = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @peripheral_neuropathy_concept_id, @encounter_id, encounter_datetime, @location_id , @peripheral_neuropathy_value_coded, @peripheral_neuropathy_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(hepatitis) THEN
            IF (hepatitis = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @hepatitis_concept_id, @encounter_id, encounter_datetime, @location_id , @hepatitis_value_coded, @hepatitis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(anaemia) THEN
            IF (anaemia = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @anaemia_concept_id, @encounter_id, encounter_datetime, @location_id , @anaemia_value_coded, @anaemia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(lactic_acidosis) THEN
            IF (lactic_acidosis = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @lactic_acidosis_concept_id, @encounter_id, encounter_datetime, @location_id , @lactic_acidosis_value_coded, @lactic_acidosis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(lipodystrophy) THEN
            IF (lipodystrophy = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @lipodystrophy_concept_id, @encounter_id, encounter_datetime, @location_id , @lipodystrophy_value_coded, @lipodystrophy_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(skin_rash) THEN
            IF (skin_rash = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @skin_rash_concept_id, @encounter_id, encounter_datetime, @location_id , @skin_rash_value_coded, @skin_rash_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #-----------------------------------------------------------------------------------------------------------------------------        
          ...
          IF NOT ISNULL(drug_induced_Abdominal_pains) THEN
            IF (drug_induced_Abdominal_pains = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_Abdominal_pains_concept_id, @encounter_idold_enc_idd, encounter_datetime, @location_id , @drug_induced_Abdominal_pains_value_coded, @drug_induced_Abdominal_pains_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_anorexia) THEN
            IF (drug_induced_anorexia = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_anorexia_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_anorexia_value_coded, @drug_induced_anorexia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_diarrhoea) THEN
            IF (drug_induced_diarrhoea = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_diarrhoea_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_diarrhoea_value_coded, @drug_induced_diarrhoea_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_jaundice) THEN
            IF (drug_induced_jaundice = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_jaundice_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_jaundice_value_coded, @drug_induced_jaundice_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_leg_pain_numbness) THEN
            IF (drug_induced_leg_pain_numbness = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_leg_pain_numbness_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_leg_pain_numbness_value_coded, @drug_induced_leg_pain_numbness_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_vomit) THEN
            IF (drug_induced_vomit = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_vomit_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_vomit_value_coded, @drug_induced_vomit_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_peripheral_neuropathy) THEN
            IF (drug_induced_peripheral_neuropathy = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_peripheral_neuropathy_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_peripheral_neuropathy_value_coded, @drug_induced_peripheral_neuropathy_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_hepatitis) THEN
            IF (drug_induced_hepatitis = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_hepatitis_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_hepatitis_value_coded, @drug_induced_hepatitis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_anaemia) THEN
            IF (drug_induced_anaemia = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_anaemia_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_anaemia_value_coded, @drug_induced_anaemia_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_lactic_acidosis) THEN
            IF (drug_induced_lactic_acidosis = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_lactic_acidosis_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_lactic_acidosis_value_coded, @drug_induced_lactic_acidosis_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_lipodystrophy) THEN
            IF (drug_induced_lipodystrophy = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_lipodystrophy_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_lipodystrophy_value_coded, @drug_induced_lipodystrophy_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_skin_rash) THEN
            IF (drug_induced_skin_rash = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_skin_rash_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_skin_rash_value_coded, @drug_induced_skin_rash_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #----------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(drug_induced_other_symptom) THEN
            IF (drug_induced_other_symptom = 'Yes') THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @drug_induced_other_symptom_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_induced_other_symptom_value_coded, @drug_induced_other_symptom_value_coded_name_id, @creator, date_created, (SELECT UUID()));
  ...
  #--------------------------------------------------------------------------------------------------------------------- 
          ...
          IF NOT ISNULL(tb_status) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @tb_status_concept_id, @encounter_id, encounter_datetime, @location_id , @tb_status_value_coded, @tb_status_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(refer_to_clinician) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @refer_to_clinician_concept_id, @encounter_id, encounter_datetime, @location_id , @refer_to_clinician_value_coded, @refer_to_clinician_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(prescribe_arv) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @prescribe_arv_concept_id, @encounter_id, encounter_datetime, @location_id , @prescribe_arv_value_coded, @prescribe_arv_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_name_brought_to_clinic1) THEN
              ...
              VALUES (patient_id, @drug_name_brought_to_clinic1_concept_id, @encounter_id, encounter_datetime, @location_id , drug_name_brought_to_clinic1, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_quantity_brought_to_clinic1) THEN
              ...
              IF (drug_quantity_brought_to_clinic1 = 'Unknown') THEN
                ...
                VALUES (patient_id, @drug_quantity_brought_to_clinic1_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_name_brought_to_clinic1_drug_id, @drug_name_brought_to_clinic1_id, drug_quantity_brought_to_clinic1, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
          ...
          IF NOT ISNULL(drug_left_at_home1) THEN
              ...
              IF (drug_left_at_home1 = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_text, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home1_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic1_drug_id, @drug_name_brought_to_clinic1_id, drug_left_at_home1, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_numeric, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home1_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic1_drug_id, @drug_name_brought_to_clinic1_id, drug_left_at_home1, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_name_brought_to_clinic2) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
              VALUES (patient_id, @drug_name_brought_to_clinic2_concept_id, @encounter_id, encounter_datetime, @location_id , drug_name_brought_to_clinic2, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_quantity_brought_to_clinic2) THEN
              ...
              IF (drug_quantity_brought_to_clinic2 = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_text, creator, date_created, uuid)
                VALUES (patient_id, @drug_quantity_brought_to_clinic2_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic2_drug_id, @drug_name_brought_to_clinic2_id, drug_quantity_brought_to_clinic2, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_numeric, creator, date_created, uuid)
                VALUES (patient_id, @drug_quantity_brought_to_clinic2_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic2_drug_id, @drug_name_brought_to_clinic2_id, drug_quantity_brought_to_clinic2, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_left_at_home2) THEN
              ...
              IF (drug_left_at_home2 = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_text, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home2_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic2_drug_id, @drug_name_brought_to_clinic2_id, drug_left_at_home2, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_numeric, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home2_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic2_drug_id, @drug_name_brought_to_clinic2_id, drug_left_at_home2, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_name_brought_to_clinic3) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
              VALUES (patient_id, @drug_name_brought_to_clinic3_concept_id, @encounter_id, encounter_datetime, @location_id , drug_name_brought_to_clinic3, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_quantity_brought_to_clinic3) THEN
              ...
              IF (drug_quantity_brought_to_clinic3 = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_text, creator, date_created, uuid)
                VALUES (patient_id, @drug_quantity_brought_to_clinic3_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic3_drug_id, @drug_name_brought_to_clinic3_id, drug_quantity_brought_to_clinic3, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_numeric, creator, date_created, uuid)
                VALUES (patient_id, @drug_quantity_brought_to_clinic3_concept_id, @encounter_id, encounter_datetime, @location_id , @drug_name_brought_to_clinic3_drug_id, @drug_name_brought_to_clinic3_id, drug_quantity_brought_to_clinic3, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_left_at_home3) THEN
              ...
              IF (drug_left_at_home3 = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_text, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home3_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic3_drug_id, @drug_name_brought_to_clinic3_id, drug_left_at_home3, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_numeric, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home3_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic3_drug_id, @drug_name_brought_to_clinic3_id, drug_left_at_home3, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_name_brought_to_clinic4) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
              VALUES (patient_id, @drug_name_brought_to_clinic4_concept_id, @encounter_id, encounter_datetime, @location_id , drug_name_brought_to_clinic4, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_quantity_brought_to_clinic4) THEN
              ...
              IF (drug_quantity_brought_to_clinic4 = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_text, creator, date_created, uuid)
                VALUES (patient_id, @drug_quantity_brought_to_clinic4_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic4_drug_id, @drug_name_brought_to_clinic4_id, drug_quantity_brought_to_clinic4, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_numeric, creator, date_created, uuid)
                VALUES (patient_id, @drug_quantity_brought_to_clinic4_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic4_drug_id, @drug_name_brought_to_clinic4_id, drug_quantity_brought_to_clinic4, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(drug_left_at_home4) THEN
              ...
              IF (drug_left_at_home4 = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_text, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home4_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic4_drug_id, @drug_name_brought_to_clinic4_id, drug_left_at_home4, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id, value_drug, obs_group_id, value_numeric, creator, date_created, uuid)
                VALUES (patient_id, @drug_left_at_home4_concept_id, @encounter_id, encounter_datetime, @location_id, @drug_name_brought_to_clinic4_drug_id, @drug_name_brought_to_clinic4_id, drug_left_at_home4, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(arv_regimen) THEN
              ...
              IF ISNULL(@arv_regimen_value_coded) THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                VALUES (patient_id, @arv_regimen_concept_id, @encounter_id, encounter_datetime, @location_id , arv_regimen,  @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
                VALUES (patient_id, @arv_regimen_concept_id, @encounter_id, encounter_datetime, @location_id , @arv_regimen_value_coded, @arv_regimen_value_coded_name_id, @creator, date_created, (SELECT UUID()));
              END IF;
          ...
          IF NOT ISNULL(prescribe_cpt) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @prescribe_cpt_concept_id, @encounter_id, encounter_datetime, @location_id , @prescribe_cpt_value_coded, @prescribe_cpt_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(number_of_condoms_given) THEN
              ...
              IF (number_of_condoms_given = 'Unknown') THEN
                # Create observation
                INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
                VALUES (patient_id, @number_of_condoms_given_concept_id, @encounter_id, encounter_datetime, @location_id , number_of_condoms_given, @creator, date_created, (SELECT UUID()));
              ELSE
                # Create observation
          ...
          IF NOT ISNULL(depo_provera_given) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @depo_provera_given_concept_id, @encounter_id, encounter_datetime, @location_id , @depo_provera_given_value_coded, @depo_provera_given_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(continue_treatment_at_clinic) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @continue_treatment_at_clinic_concept_id, @encounter_id, encounter_datetime, @location_id , @continue_treatment_at_clinic_value_coded, @continue_treatment_at_clinic_value_coded_name_id, @creator, date_created, (SELECT UUID()));
          ...
          IF NOT ISNULL(continue_art) THEN
              ...
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @continue_art_concept_id, @encounter_id, encounter_datetime, @location_id , @continue_art_value_coded, @continue_art_value_coded_name_id, @creator, date_created, (SELECT UUID()));
