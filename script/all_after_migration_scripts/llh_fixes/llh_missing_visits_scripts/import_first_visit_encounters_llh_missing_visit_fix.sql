...
DROP PROCEDURE IF EXISTS `proc_import_first_visit_encounters_llh_missing_visit`$$

# Procedure does not take any parameters. It assumes fixed table names and database
# names as working with flexible names is not supported as of writing in MySQL.
CREATE PROCEDURE `proc_import_first_visit_encounters_llh_missing_visit`(
...
`bart1_intermediate_bare_bones`.`first_visit_encounters`.`creator`, COALESCE(`bart1_intermediate_bare_bones`.`visit_encounters`.visit_date, `bart1_intermediate_bare_bones`.`first_visit_encounters`.date_created) FROM `bart1_intermediate_bare_bones`.`first_visit_encounters` LEFT OUTER JOIN `bart1_intermediate_bare_bones`.`visit_encounters` ON
        ...
        AND `bart1_intermediate_bare_bones`.`first_visit_encounters`.`encounter_datetime` = in_encounter_datetime;
...
DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
  ...
  SET @provider = COALESCE((SELECT person_id FROM users WHERE user_id = @creator LIMIT 1), 1);
	...
	SET @encounter_type = (SELECT encounter_type_id FROM encounter_type WHERE name = 'HIV CLINIC REGISTRATION' LIMIT 1);
	...
	SET @encounter_id = (SELECT LAST_INSERT_ID());
        ...
        IF NOT ISNULL(agrees_to_follow_up) THEN
            ...
            VALUES (patient_id, @agrees_to_follow_up_concept_id, @encounter_id, encounter_datetime, @location_id , @agrees_to_follow_up_value_coded, @agrees_to_follow_up_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(date_of_hiv_pos_test) THEN
            ...
            VALUES (patient_id, @date_of_hiv_pos_test_concept_id, @encounter_id, encounter_datetime, @location_id , date_of_hiv_pos_test, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(date_of_hiv_pos_test_estimated) THEN
            ...
            VALUES (patient_id, @date_of_hiv_pos_test_estimated_concept_id, @encounter_id, encounter_datetime, @location_id , date_of_hiv_pos_test_estimated, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(location_of_hiv_pos_test) THEN
            ...
            VALUES (patient_id, @location_of_hiv_pos_test_concept_id, @encounter_id, encounter_datetime, @location_id , location_of_hiv_pos_test, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(arv_number_at_that_site) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @arv_number_at_that_site_concept_id, @encounter_id, encounter_datetime, @location_id , arv_number_at_that_site, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(location_of_art_initiation) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @location_of_art_initiation_concept_id, @encounter_id, encounter_datetime, @location_id , location_of_art_initiation, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(taken_arvs_in_last_two_months) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @taken_arvs_in_last_two_months_concept_id, @encounter_id, encounter_datetime, @location_id , @taken_arvs_in_last_two_months_value_coded, @taken_arvs_in_last_two_months_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(taken_arvs_in_last_two_weeks) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @taken_arvs_in_last_two_weeks_concept_id, @encounter_id, encounter_datetime, @location_id , @taken_arvs_in_last_two_weeks_value_coded, @taken_arvs_in_last_two_weeks_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(has_transfer_letter) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @has_transfer_letter_concept_id, @encounter_id, encounter_datetime, @location_id , @has_transfer_letter_value_coded, @has_transfer_letter_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(site_transferred_from) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @site_transferred_from_concept_id, @encounter_id, encounter_datetime, @location_id , site_transferred_from, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(date_of_art_initiation) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_datetime, creator, date_created, uuid)
            VALUES (patient_id, @date_of_art_initiation_concept_id, @encounter_id, encounter_datetime, @location_id , date_of_art_initiation, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(ever_registered_at_art) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @ever_registered_at_art_concept_id, @encounter_id, encounter_datetime, @location_id , @ever_registered_at_art_value_coded, @ever_registered_at_art_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(ever_received_arv) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @ever_received_arv_concept_id, @encounter_id, encounter_datetime, @location_id , @ever_received_arv_value_coded, @ever_received_arv_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(last_arv_regimen) THEN
            ...
            IF ISNULL(@last_arv_regimen_value_coded) THEN
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
              VALUES (patient_id, @last_arv_regimen_concept_id, @encounter_id, encounter_datetime, @location_id , last_arv_regimen, @creator, date_created, (SELECT UUID()));
            ELSE
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
              VALUES (patient_id, @last_arv_regimen_concept_id, @encounter_id, encounter_datetime, @location_id , @last_arv_regimen_value_coded, @last_arv_regimen_value_coded_name_id, @creator, date_created, (SELECT UUID()));
            END IF;
        ...
        IF NOT ISNULL(date_last_arv_taken) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_datetime, creator, date_created, uuid)
            VALUES (patient_id, @date_last_arv_taken_concept_id, @encounter_id, encounter_datetime, @location_id , date_last_arv_taken, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(date_last_arv_taken_estimated) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_boolean, creator, date_created, uuid)
            VALUES (patient_id, @date_last_arv_taken_estimated_concept_id, @encounter_id, encounter_datetime, @location_id , date_last_arv_taken_estimated, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(weight) THEN
          ...
          IF (weight = 'Unknown') THEN
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @weight_concept_id, @encounter_id, encounter_datetime, @location_id , weight, @creator, date_created, (SELECT UUID()));
          ELSE
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_numeric, creator, date_created, uuid)
            VALUES (patient_id, @weight_concept_id, @encounter_id, encounter_datetime, @location_id , ROUND(weight,1), @creator, date_created, (SELECT UUID()));
          END IF;
        ...
        IF NOT ISNULL(height) THEN
          ...
          IF (height = 'Unknown') THEN
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @height_concept_id, @encounter_id, encounter_datetime, @location_id , height, @creator, date_created, (SELECT UUID()));
          ELSE
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_numeric, creator, date_created, uuid)
            VALUES (patient_id, @height_concept_id, @encounter_id, encounter_datetime, @location_id , height, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(bmi) THEN
            ...
            IF (bmi = 'Unknown') THEN
              # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
              VALUES (patient_id, @bmi_concept_id, @encounter_id, encounter_datetime, @location_id , bmi, @creator, date_created, (SELECT UUID()));
            ELSE
               # Create observation
              INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_numeric, creator, date_created, uuid)
              VALUES (patient_id, @bmi_concept_id, @encounter_id, encounter_datetime, @location_id , ROUND(bmi,1), @creator, date_created, (SELECT UUID()));
            END IF;
