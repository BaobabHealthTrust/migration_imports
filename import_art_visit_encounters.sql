...
DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
	...
	INSERT INTO encounter (encounter_id, encounter_type, patient_id, provider_id, location_id, encounter_datetime, creator, date_created, uuid) VALUES (visit_encounter_id, @encounter_type, patient_id, @creator, @location_id, visit_date, @creator, date_created, (SELECT UUID())) ON DUPLICATE KEY UPDATE encounter_id = visit_encounter_id;
        ...
        IF NOT ISNULL(family_planning_method_used) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @family_planning_method_used_concept_id, visit_encounter_id, visit_date, @location_id , @family_planning_method_used_value_coded, @family_planning_method_used_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(other_symptoms) THEN
            ...
            SET @other_symptoms_value_coded = (SELECT concept_name.concept_id FROM concept_name concept_name
                        LEFT OUTER JOIN concept ON concept.concept_id = concept_name.concept_id
                        WHERE name = other_symptoms AND voided = 0 AND retired = 0 LIMIT 1);
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @other_symptoms_concept_id, visit_encounter_id, visit_date, @location_id , @other_symptoms_value_coded, @other_symptoms_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(prescribe_arv) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @prescribe_arv_concept_id, visit_encounter_id, visit_date, @location_id , @prescribe_arv_value_coded, @prescribe_arv_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_name_brought_to_clinic1) THEN
            ...
            VALUES (patient_id, @drug_name_brought_to_clinic1_concept_id, visit_encounter_id, visit_date, @location_id , drug_name_brought_to_clinic1, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_quantity_brought_to_clinic1) THEN
            ...
            VALUES (patient_id, @drug_quantity_brought_to_clinic1_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic1_id, drug_quantity_brought_to_clinic1, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_left_at_home1) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , obs_group_id, value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_left_at_home1_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic1_id, drug_left_at_home1, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_name_brought_to_clinic2) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_name_brought_to_clinic2_concept_id, visit_encounter_id, visit_date, @location_id , drug_name_brought_to_clinic2, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_quantity_brought_to_clinic2) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , obs_group_id, value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_quantity_brought_to_clinic2_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic2_id, drug_quantity_brought_to_clinic2, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_left_at_home2) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , obs_group_id, value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_left_at_home2_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic2_id, drug_left_at_home2, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_name_brought_to_clinic3) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_name_brought_to_clinic3_concept_id, visit_encounter_id, visit_date, @location_id , drug_name_brought_to_clinic3, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_quantity_brought_to_clinic3) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , obs_group_id, value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_quantity_brought_to_clinic3_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic3_id, drug_quantity_brought_to_clinic3, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_left_at_home3) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , obs_group_id, value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_left_at_home3_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic3_id, drug_left_at_home3, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_name_brought_to_clinic4) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_name_brought_to_clinic4_concept_id, visit_encounter_id, visit_date, @location_id , drug_name_brought_to_clinic4, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_quantity_brought_to_clinic4) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , obs_group_id, value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_quantity_brought_to_clinic4_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic4_id, drug_quantity_brought_to_clinic4, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(drug_left_at_home4) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , obs_group_id, value_text, creator, date_created, uuid)
            VALUES (patient_id, @drug_left_at_home4_concept_id, visit_encounter_id, visit_date, @location_id , @drug_name_brought_to_clinic4_id, drug_left_at_home4, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(arv_regimen) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @arv_regimen_concept_id, visit_encounter_id, visit_date, @location_id , @arv_regimen_value_coded, @arv_regimen_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(number_of_condoms_given) THEN
            ...
            VALUES (patient_id, @number_of_condoms_given_concept_id, visit_encounter_id, visit_date, @location_id , number_of_condoms_given, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(depo_provera_given) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @depo_provera_given_concept_id, visit_encounter_id, visit_date, @location_id , @depo_provera_given_value_coded, @depo_provera_given_value_coded_name_id, @creator, date_created, (SELECT UUID()));
        ...
        IF NOT ISNULL(continue_treatment_at_clinic) THEN
            ...
            # Create observation
            INSERT INTO obs (person_id, concept_id, encounter_id, obs_datetime, location_id , value_coded, value_coded_name_id, creator, date_created, uuid)
            VALUES (patient_id, @continue_treatment_at_clinic_concept_id, visit_encounter_id, visit_date, @location_id , @continue_treatment_at_clinic_value_coded, @continue_treatment_at_clinic_value_coded_name_id, @creator, date_created, (SELECT UUID()));
