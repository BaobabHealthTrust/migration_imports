...
--
-- Host: localhost    Database: pih_live
-- ------------------------------------------------------
...
--
-- Temporary table structure for view `arv_drug`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=27449 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE TABLE `earliest_start_date` (
  `patient_id` tinyint NOT NULL,
  `date_enrolled` tinyint NOT NULL,
  `earliest_start_date` tinyint NOT NULL,
  `death_date` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=249826 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `ever_registered_obs`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `ever_registered_obs` (
  `obs_id` tinyint NOT NULL,
  `person_id` tinyint NOT NULL,
  `concept_id` tinyint NOT NULL,
  `encounter_id` tinyint NOT NULL,
  `order_id` tinyint NOT NULL,
  `obs_datetime` tinyint NOT NULL,
  `location_id` tinyint NOT NULL,
  `obs_group_id` tinyint NOT NULL,
  `accession_number` tinyint NOT NULL,
  `value_group_id` tinyint NOT NULL,
  `value_boolean` tinyint NOT NULL,
  `value_coded` tinyint NOT NULL,
  `value_coded_name_id` tinyint NOT NULL,
  `value_drug` tinyint NOT NULL,
  `value_datetime` tinyint NOT NULL,
  `value_numeric` tinyint NOT NULL,
  `value_modifier` tinyint NOT NULL,
  `value_text` tinyint NOT NULL,
  `date_started` tinyint NOT NULL,
  `date_stopped` tinyint NOT NULL,
  ...
  `date_voided` tinyint NOT NULL,
  `void_reason` tinyint NOT NULL,
  `value_complex` tinyint NOT NULL,
  `uuid` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=1121579 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=84732 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11803 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17269 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE TABLE `patient_state_on_arvs` (
  `patient_state_id` tinyint NOT NULL,
  `patient_program_id` tinyint NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=22123 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=55502 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=21266 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 DROP TABLE IF EXISTS `arv_drug`*/;
/*!50001 DROP VIEW IF EXISTS `arv_drug`*/;
...
/*!50001 DROP TABLE IF EXISTS `ever_registered_obs`*/;
/*!50001 DROP VIEW IF EXISTS `ever_registered_obs`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY INVOKER */
/*!50001 VIEW `patient_pregnant_obs` AS select `obs`.`obs_id` AS `obs_id`,`obs`.`person_id` AS `person_id`,`obs`.`concept_id` AS `concept_id`,`obs`.`encounter_id` AS `encounter_id`,`obs`.`order_id` AS `order_id`,`obs`.`obs_datetime` AS `obs_datetime`,`obs`.`location_id` AS `location_id`,`obs`.`obs_group_id` AS `obs_group_id`,`obs`.`accession_number` AS `accession_number`,`obs`.`value_group_id` AS `value_group_id`,`obs`.`value_boolean` AS `value_boolean`,`obs`.`value_coded` AS `value_coded`,`obs`.`value_coded_name_id` AS `value_coded_name_id`,`obs`.`value_drug` AS `value_drug`,`obs`.`value_datetime` AS `value_datetime`,`obs`.`value_numeric` AS `value_numeric`,`obs`.`value_modifier` AS `value_modifier`,`obs`.`value_text` AS `value_text`,`obs`.`date_started` AS `date_started`,`obs`.`date_stopped` AS `date_stopped`,`obs`.`comments` AS `comments`,`obs`.`creator` AS `creator`,`obs`.`date_created` AS `date_created`,`obs`.`voided` AS `voided`,`obs`.`voided_by` AS `voided_by`,`obs`.`date_voided` AS `date_voided`,`obs`.`void_reason` AS `void_reason`,`obs`.`value_complex` AS `value_complex`,`obs`.`uuid` AS `uuid` from `obs` where ((`obs`.`concept_id` in (6131,1755)) and (`obs`.`value_coded` = 1065) and (`obs`.`voided` = 0)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2013-04-05 10:25:03
